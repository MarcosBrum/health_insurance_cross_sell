...
class CrossSell:
    def __init__(self):
        ...
        self.mms_vintage = pickle.load(open("encoders/vintage_new_scaler.pkl", "rb"))
        self.age_encoder = pickle.load(open("encoders/v_age_new_encoder.pkl", "rb"))
        self.damage_encoder = pickle.load(open("encoders/v_dam_new_encoder.pkl", "rb"))
